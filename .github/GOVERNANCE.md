...
career-ops is maintained by [Tony Walteur](https://www.linkedin.com/in/tonywalteur/) ([@mysticalsin](https://github.com/mysticalsin)) under a **BDFL (Benevolent Dictator for Life)** model with a clear path for community members to earn trust and take on responsibilities.
...
4. **Understand the project** — read CLAUDE.md, docs/DATA_CONTRACT.md, the architecture docs
