...
- Dashboard TUI features (in `apps/tui/`)
...
node engine/tracker/verify-pipeline.mjs     # Health check
node engine/tracker/cv-sync-check.mjs        # Config check
...
The "career-ops" name itself is governed by [docs/TRADEMARK.md](docs/TRADEMARK.md).
