...
import (
	...
	"github.com/mysticalsin/Hireloom/apps/tui/internal/data"
	"github.com/mysticalsin/Hireloom/apps/tui/internal/model"
	"github.com/mysticalsin/Hireloom/apps/tui/internal/theme"
)
...
func (m PipelineModel) renderHelp() string {
	...
	brand := lipgloss.NewStyle().Foreground(m.theme.Overlay).Render("Hireloom by Tony Walteur")
