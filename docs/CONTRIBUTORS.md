...
- **[@piscespieces](https://github.com/piscespieces)** (Andres Urdaneta) — Docs architect. Maintains the getting-started guides at [career-ops-docs.vercel.app](https://career-ops-docs.vercel.app). Shipped [PR #286](https://github.com/mysticalsin/Hireloom/pull/286) (portals cleanup). Authored the comparative analysis that defines what career-ops is vs. isn't.

## Shipping with the project

- **[@CURT1S03](https://github.com/CURT1S03)** (Curtis) — LaTeX/Overleaf CV export ([PR #362](https://github.com/mysticalsin/Hireloom/pull/362), merged — resolves [#47](https://github.com/mysticalsin/Hireloom/issues/47))
- **[@vivek-gite](https://github.com/vivek-gite)** — A16Z provider support ([PR #271](https://github.com/mysticalsin/Hireloom/pull/271), in review)
...
See [.github/CONTRIBUTING.md](.github/CONTRIBUTING.md) and the [Contributor Ladder](.github/GOVERNANCE.md#contributor-ladder) in .github/GOVERNANCE.md. Open an issue first for anything beyond a typo fix — we merge fast when scope is clear.
