...
| `templates/BUILD-CHANGELOG.template.md` | Contribution change-log template (your filled `BUILD-CHANGELOG.md` is user layer) |
| `engine/batch/batch-prompt.md` | Batch worker prompt |
| `engine/batch/batch-runner.sh` | Batch orchestrator |
| `apps/tui/*` | Go TUI dashboard |
