 ...
 *
 * Usage:
 *   node scrape-forms.mjs                 → all packages in output/autoapply/
 *   node scrape-forms.mjs --num 15        → single package
 *   node scrape-forms.mjs --workers 3     → concurrency (default 3)
 *   node scrape-forms.mjs --only-missing  → skip packages already scraped
 */
