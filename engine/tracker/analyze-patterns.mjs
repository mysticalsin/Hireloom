 ...
 *
 * Run: node engine/tracker/analyze-patterns.mjs          (JSON to stdout)
 *      node engine/tracker/analyze-patterns.mjs --summary (human-readable table)
 *      node engine/tracker/analyze-patterns.mjs --min-threshold 3
 */
