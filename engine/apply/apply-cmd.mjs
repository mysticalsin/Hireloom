 ...
 *
 * Usage:
 *   node engine/apply/apply-cmd.mjs goto "<url>"
 *   node engine/apply/apply-cmd.mjs fill --cv "<resume.pdf>" --cover "<cover.pdf>" --jd "<jd.txt>" --role "Company — Role"
 *   node engine/apply/apply-cmd.mjs status
 *   node engine/apply/apply-cmd.mjs quit
 */
