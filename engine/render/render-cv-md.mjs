 ...
 *
 * Usage: node engine/render/render-cv-md.mjs "<in.md>" "<out.pdf>"
 */
...
if (!inPath || !outPath) { console.error('Usage: node engine/render/render-cv-md.mjs "<in.md>" "<out.pdf>"'); process.exit(1); }
