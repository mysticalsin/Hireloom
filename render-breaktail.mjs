...
// Usage: node render-breaktail.mjs "<content.json>" "<outDir>" "<baseName>" [breaktail]
...
if (!jsonPath || !outDir || !baseName) {
  console.error('Usage: node render-breaktail.mjs "<content.json>" "<outDir>" "<baseName>" [breaktail]');
  process.exit(1);
}
